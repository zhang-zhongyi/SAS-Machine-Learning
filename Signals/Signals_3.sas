...
/* Use PROC FREQ and PROC SQL to describe the volume and characteristics of the population.  */
/* PROC FREQ becomes more informative with formatted variables */
/* Add a WHERE statement to modify the denominator */
title 'Volume and characteristics of the population';
title2 'Note factors driving the incidence of the injury';
...
/* Use OUTOBS to restrict the number of outputted rows */
...
/* Output to screen for easy review */
/* Use new_date to calculate the monthly frequency, national estimate,  */
/* and ratio to other of national estimate */
