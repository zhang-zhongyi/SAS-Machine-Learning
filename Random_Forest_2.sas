...
/* use PROC SQL TO QUERY & OUTBOBS to limit the output */

/* +++++++++++++++++++++++++++++++++++++++ */
/* Examine the Las Vegas inspection data */
/* +++++++++++++++++++++++++++++++++++++++ */
title 'Las Vegas Restaurant inspection results';
proc sql outobs=10;
	select *
	from yelp.lv_inspections;
quit;

/* +++++++++++++++++++++++++++++++++++++++ */
/* Examine the Yelp business data */
/* +++++++++++++++++++++++++++++++++++++++ */
title 'Yelp Business Data';
proc sql outobs=10;
	select *
	from yelp.business;
quit;
...
/* +++++++++++++++++++++++++++++++++++++++ */
/* Examine the input data for tree modeling and RF */
/* +++++++++++++++++++++++++++++++++++++++ */
title 'Tree Modeling Input LV Inspection+Yelp Tips';
proc sql outobs=10;
	select *
	from yelp.lv_inspection_tree;
quit;
...
title3 'Note: CVCC output, CVMODEL fitting, ASSIGNMISSING, REDUCEDERROR pruning options';
title4 'Note 2: VAR: is specified as a continuous variable';
title5 'Model intended to predict total number of demerits';
